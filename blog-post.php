...
class blog_post {
    ...
    public function qa_blog_write($userid, $blog_cats) {
        ...
        // process the form if publish is clicked
    ...
    public function qa_blog_post($userid, $permalink) {
        ...
        if ($formtype == 'q_edit') { // ...in edit mode
            ...
            if (array_key_exists('title', $qa_content)) {
        ...
        if ($article['basetype'] == 'P') {
            ...
            if ($countfortitle > 0) {
                $split = $countfortitle == 1 ? qa_lang_html_sub_split('article/1_comment_title', '1', '1') : qa_lang_html_sub_split('article/x_comments_title', $countfortitle);
