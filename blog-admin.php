...
class qa_html_theme_layer extends qa_html_theme_base {
    ...
    // changed constructor name to be compatible with new standards
    ...
    function bp_blog_categories() {
        ...
        if ($setmissing) {
            $this->content['form'] = array(
                ...
                'fields' => array(
                    'reassign' => array(
                        'label' => isset($editcategory) ? qa_lang_html_sub('admin/category_no_sub_to', qa_html($editcategory['title'])) : qa_lang_html('admin/category_none_to'),
                        'loose' => true,
                    ),
                ),
                'buttons' => array(
            ...
            if ($setparent) {
                ...
                $this->content['form']['fields']['blogposts'] = array(
                    ...
                    ($editcategory['pcount'] == 1 ? qa_lang_html_sub('bp_lang/1_blogpost', '1', '1') : qa_lang_html_sub('bp_lang/x_blogposts', qa_format_number($editcategory['pcount']))
                    ) . '</a>',
                );
                ...
                if ($hassubcategory && !qa_opt('bp_allow_no_sub_blogcat')) {
                    ...
                    if ($nosubcount) {
                        $this->content['form']['fields']['blogposts']['error'] = strtr(qa_lang_html('admin/category_no_sub_error'), array(
            ...
            if (!$setparent) {
                ...
                if (count($categories)) {
                    ...
                    $this->content['form']['fields']['parent']['value'] = '<a href="' . qa_path_html(qa_request(), array('edit' => @$editcategory['parentid'])) . '">' .
            ...
            if (count($categories)) {
                ...
                foreach ($categories as $category) {
                    if (!isset($category['parentid'])) {
                        $navcategoryhtml .= '<a href="' . qa_path_html('admin/bp_categories', array('edit' => $category['catid'])) . '">' .
                                qa_html($category['title']) .
                                '</a> - ' .
                                ($category['pcount'] == 1 ? qa_lang_html_sub('bp_lang/1_blogpost', '1', '1') : qa_lang_html_sub('bp_lang/x_blogposts', qa_format_number($category['pcount']))
                                ) . '<br/>';
                    }
                }
                ...
                if (!qa_opt('bp_allow_no_blogcat')) {
                    ...
                    if ($nocatcount) {
                        $this->content['form']['fields']['bp_allow_no_blogcat']['error'] = strtr(qa_lang_html('bp_lang/category_none_error'), array(
    ...
    // changed the name of this method from bp_blog_moderation
